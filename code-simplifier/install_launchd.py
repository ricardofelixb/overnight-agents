#!/usr/bin/env python3
"""Install or remove the native macOS code-simplifier schedule."""
...
def main() -> int:
    ...
    try:
        ...
        legacy = launchd.run(["crontab", "-l"], check=False)
        if "code-simplifier/simplify.sh" in legacy.stdout:
            print("warning: an inert legacy cron entry remains; remove it manually")
        return 0
